...
public class PageService {
    ...
    public PageResponseDTO.Main getMainPage(Long memberId) {
        ...
        ItemResponseDTO.ItemList imminentItemList = itemService.getImminentItemList(PAGE, SIZE);
        ItemResponseDTO.ItemList popularItemList = itemService.getPopularItemList(PAGE, SIZE);
        ItemResponseDTO.ItemList subscribedItemList = itemService.getSubscribedItemList(memberId, PAGE, SIZE);
