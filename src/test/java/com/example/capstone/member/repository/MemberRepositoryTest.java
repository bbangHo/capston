...
public class MemberRepositoryTest {
    ...
    void searchSubscribedSeller(){
        ...
        // when
        Page<Seller> sellerList = sellerRepository.findSubscribedSeller(storedMembers.get(0).getId(), PageRequest.of(0, 100, Sort.by("createdAt").descending()));
        ...
        assertThat(sellerList.getContent().get(0).getCreatedAt().isBefore(sellerList.getContent().get(1).getCreatedAt()));
